...
class RoboRoombaController(Node):
    def __init__(self):
        super().__init__('robo_roomba_controller_node')
    ...
    def detect_back_collision(self):
        ...
        if (self.left_back_tof_dist < 0.2 or self.right_back_tof_dist < 0.2):
